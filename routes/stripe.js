...
// ✅ FIXED: Create payment intent - CHANGED CURRENCY FROM 'eur' TO 'gbp'
router.post('/create-payment-intent', async (req, res) => {
    try {
        ...
        // Create payment intent - CHANGED: 'eur' to 'gbp' (British Pounds)
        const paymentIntent = await stripe.paymentIntents.create({
            amount: Math.round(amount * 100), // Convert to pence (not cents)
            currency: 'gbp', // FIXED: Changed from 'eur' to 'gbp'
            metadata: {
                orderId: orderId,
...
// ✅ FIXED: Confirm payment - CHANGED CURRENCY VALIDATION
